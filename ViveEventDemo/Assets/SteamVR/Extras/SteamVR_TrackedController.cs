...
public class SteamVR_TrackedController : MonoBehaviour
{
    ...
    //@cartzhang
    public event ClickedEventHandler TriggerPressDown;
    ...
    //@cartzhang add press down
    public virtual void OnTriggerPressDown(ClickedEventArgs e)
    {
        if (TriggerPressDown != null)
            TriggerPressDown(this, e);
    }
